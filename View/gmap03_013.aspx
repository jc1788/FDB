<%@ page language="C#" autoeventwireup="true" inherits="View_gmap03_013, App_Web_qgy0chct" %>
  ...
  <body>
    ...
    <script type="text/javascript">
        ...
        function initialize_kml(checked, id) {
            ...
            /*
            var xy_array2 = document.getElementById('mapxy').value.split(';');
            var center_x;
            var center_y;
            for (var i = 0; i < xy_array2.length - 1; i++) {
                var xy2 = xy_array[i].split(',');
                if (i = 0) {
                    center_x = xy2[1];
                    center_y = xy2[0];
                }
            ...
            */
            ...
            for (var i = 0; i < xy_array.length - 1; i++) {
                ...
                //alert(xy[1]);
                var url = "fun03_013.aspx?x=" + xy[1] + "&y=" + xy[0];
                var title = "經度 : " + xy[1] + "\n" + "緯度 : " + xy[0];
