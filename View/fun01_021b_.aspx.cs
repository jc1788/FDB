...
public partial class View_fun01_021b : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        map_url = map_url.Replace("fun01_021b_.aspx", "gmap01_021b.aspx");
    ...
    protected void Query()
    {
        ...
        if (!value_start_end.Equals("ALL"))
        {
            ...
            sql_xy += " and a.x <= (select max_x from Engineering_road_scope where start_end = '" + value_start_end + "') ";
            sql_xy += " and a.x >= (select min_x from Engineering_road_scope where start_end = '" + value_start_end + "') ";
            sql_xy += " and a.y <= (select max_y from Engineering_road_scope where start_end = '" + value_start_end + "') ";
            sql_xy += " and a.y >= (select min_y from Engineering_road_scope where start_end = '" + value_start_end + "') ";
        }
        */
        ...
        //if (!value_group.Equals("") || !value_start_end.Equals("") || !value_class2.Equals("") || !value_class1.Equals("") || !value_Sensitive_Level.Equals(""))
        if (!value_group.Equals("") || !value_class2.Equals("") || !value_class1.Equals("") || !value_Sensitive_Level.Equals(""))
        {
            Get_XY(sql_xy);
        }
