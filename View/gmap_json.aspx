<%@ page language="C#" autoeventwireup="true" inherits="View_gmap_json, App_Web_drtrsv5c" %>
...
<html>
  <head>
    ...
    <style type="text/css">
      ...
      <title></title>
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?sensor=false&language=EN">
    </script>
