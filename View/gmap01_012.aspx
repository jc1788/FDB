<%@ page language="C#" autoeventwireup="true" inherits="View_gmap01_012, App_Web_drtrsv5c" %>
...
//                    window.open(this.url, '_blank');
            ...
            */
            ...
            if (document.getElementById('sent2').checked) {
                ...
                //var Layer_sent2 = new google.maps.KmlLayer('2.kmz');
            ...
            if (document.getElementById('sent3').checked) {
                ...
                //var Layer_sent3 = new google.maps.KmlLayer('3.kmz');
