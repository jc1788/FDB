<%@ Page Language="C#" MasterPageFile="front.master" AutoEventWireup="true" CodeFile="plant_add.aspx.cs" Inherits="plant_add" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContentPlaceHolder" runat="Server">
    ...
    <div class="bg-gradient-primary">
        <div class="container">
            <div class="d-flex justify-content-between">
                <h4 class="py-2 h4 text-white">現況植栽資料新增</h4>
                <nav class="breadcrumbNav  d-none d-md-block d-lg-block d-xl-block"
                    ...
                    <ol class="breadcrumb mt12">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">現況植栽資料新增</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <main class="container" id="page">
            ...
            <div class="col-12 col-lg-8 mx-auto ">
                <table class="mb-4 itemTable itemTableEdit">
                    <tbody>
                        <tr>
                            ...
                            <td><asp:DropDownList ID="Office" Cssclass="form-select-inline" aria-label="Default select example" runat="server" AppendDataBoundItems="True" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="class1" DataValueField="class1"></asp:DropDownList>
				<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:freewayDbConnectionString %>" SelectCommand="SELECT 0 AS id , 'ALL' AS  class1 UNION ALL Select Top 1 id , class1 FROM Engineering_road Where class1 = '北區養護工程分局' UNION ALL Select Top 1 id , class1 FROM Engineering_road Where class1 = '中區養護工程分局' UNION ALL Select Top 1 id , class1 FROM Engineering_road Where class1 = '南區養護工程分局' ORDER BY id"></asp:SqlDataSource>
                        ...
                        <tr>
                            ...
                            <td><asp:DropDownList ID="Segment" Cssclass="form-select-inline" aria-label="Default select example" runat="server" AppendDataBoundItems="False" AutoPostBack="True" DataSourceID="SqlDataSource2" DataTextField="class3" DataValueField="class3"></asp:DropDownList>
				<asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:freewayDbConnectionString %>" SelectCommand="SELECT DISTINCT class2, REPLACE(class2,'工務段','') as class3 FROM [Engineering_road] Where (class1=@class1) ORDER BY class2">
				    <SelectParameters><asp:ControlParameter ControlID="Office" Name="class1" PropertyName="SelectedValue" Type="string" /></SelectParameters>
				</asp:SqlDataSource>
                                </td>
                        </tr>
                        <tr>
	    ...
	    <asp:Button ID="Add_Plant" Cssclass="btn btn-primary" runat="server" OnClick="Add_Plant_Click" Text="新增" />
        </div>
    </main>
</asp:Content>
