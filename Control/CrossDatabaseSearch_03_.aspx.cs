...
public partial class Control_CrossDatabaseSearch_03 : System.Web.UI.Page
{
    ...
    protected void Query_Url_02()
    {
        ...
        //string url = "<script language='javascript'>window.open('" + "fun02_011f.aspx?KeyWords=" + value_KeyWords + "&species=" + value_species + "&StartDate=" + value_StartDate + "&EndDate=" + value_EndDate + "&x1=" + x1 + "&y1=" + y1 + "&x2=" + x2 + "&y2=" + y2 + "','_blank');</script>)";
        //Response.Write(url);
        //Response.Redirect(url,false);
        //Response.Write("<script language='javascript'>window.open('" + url + "','_blank')</script>");
    }
    ...
    protected void Button_Query_Click(object sender, EventArgs e)
    {
        ...
        {
            if (search1.Checked) Query_Url();
            if (search2.Checked) Query_Url_02();
        }
    }
}