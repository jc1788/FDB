...
public partial class Control_Batch_Upload_Plants : System.Web.UI.Page
{
    ...
    public void ReadExcel(string DataSource, string SheetName, string upload_file, string image_file, string image_file2)
    {
		...
		Response.Write(error_siteid);
            ...
            redirect_str = "Plants_tmp_.aspx?counts_error=" + counts_error + "&counts_ok=" + counts_ok;
    ...
    protected void Upload_Month_NoRecord(object sender, EventArgs e)
    {
        ...
        Response.Write("<script>alert('設定本月無資料完成!');location.href='Batch_Upload_Roadkill.aspx'; </script>");
