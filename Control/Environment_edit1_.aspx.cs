...
public partial class Control_Environment_edit1 : System.Web.UI.Page
{
    ...
    {
        string sql = " SELECT [id], [plan_name], [plan_id], [type], CONVERT (char(10), [start_date], 126) AS [start_date], CONVERT (char(10), [end_date], 126) AS [end_date], [owner], [provider], [location], [keywords], [abstracts] FROM [Environment] ";
