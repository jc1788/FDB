<%@ Page Language="C#" MasterPageFile="front.master" AutoEventWireup="true" CodeFile="road_status_add.aspx.cs" Inherits="road_status_add" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContentPlaceHolder" runat="Server">
    ...
    <main class="container" id="page">
        ...
        <p class="my-3"><a href="road_status.aspx">取消新增</a></p>
            ...
            <div class="col-12 col-lg-8 mx-auto ">
				...
				&nbsp;&nbsp;
                        ...
                        <tr>
                            ...
                            <td><asp:DropDownList ID="maintain1" Cssclass="form-select-inline" aria-label="Default select example" runat="server" AppendDataBoundItems="True" AutoPostBack="True" DataSourceID="SqlDataSource4" DataTextField="class1" DataValueField="class1"></asp:DropDownList>
				...
				<asp:DropDownList ID="maintain2" Cssclass="form-select-inline" aria-label="Default select example" runat="server" AppendDataBoundItems="False" AutoPostBack="True" DataSourceID="SqlDataSource5" DataTextField="class2" DataValueField="class2"></asp:DropDownList>
				<asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:freewayDbConnectionString %>" SelectCommand="SELECT DISTINCT class2 FROM [Engineering_road] Where (class1=@class1) ORDER BY class2">
				    <SelectParameters><asp:ControlParameter ControlID="maintain1" Name="class1" PropertyName="SelectedValue" Type="string" /></SelectParameters>
				</asp:SqlDataSource>
			    </td>
                        </tr> 
                        <tr>
                            <th scope="row"><asp:Label ID="lb_doc_no" Cssclass="form-label" AssociatedControlId="doc_no" runat="server">公文文號：</asp:Label></th>
                            <td><asp:TextBox ID="doc_no" Cssclass="form-control" runat="server" /></td>
                        </tr>
                        <tr>
	    ...
	    <asp:Button ID="Add_Road_status" Cssclass="btn btn-primary" runat="server" OnClick="Add_Road_status_Click" Text="新增路權空間資料" />
        </div>
