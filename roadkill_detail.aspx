<%@ Page Language="C#" MasterPageFile="front.master" AutoEventWireup="true" CodeFile="roadkill_detail.aspx.cs" Inherits="roadkill_detail" %>
...
<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadContentPlaceHolder" runat="Server">
    ...
    function init() {
	map = L.map('leafletmap', { fullscreenControl: true, scrollWheelZoom: false }).setView([23.5, 121.0], 8);
    ...
    <div class="bg-gradient-primary">
        <div class="container">
            <div class="d-flex justify-content-between">
                <h4 class="py-2 h4 text-white">道路致死資料詳情</h4>
                <nav class="breadcrumbNav  d-none d-md-block d-lg-block d-xl-block"
                    ...
                    <ol class="breadcrumb mt12">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">道路致死資料詳情</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="col-12 col-lg-5">
                <table class="mb-4 itemTable">
                    <tbody>
                        ...
                        <tr>
                            <th scope="row">里程：</th>
                            <td><asp:Literal ID="milestone" runat="server"></asp:Literal></td>
                        </tr>
                        <tr>
                            <th scope="row">經度X：</th>
                        ...
                        <tr>
                            <th scope="row">範圍：</th>
                            <td><asp:Literal ID="range" runat="server"></asp:Literal></td>
                        </tr>
                        <tr>
                            <th scope="row">工作類別：</th>
                            <td><asp:Literal ID="type" runat="server"></asp:Literal></td>
                        </tr>
                        <tr>
                            <th scope="row">天氣：</th>
                            <td><asp:Literal ID="weather" runat="server"></asp:Literal></td>
                        </tr>
                        <tr>
                            <th scope="row">大類：</th>
                            <td><asp:Literal ID="animal" runat="server"></asp:Literal></td>
                        </tr>
                        <tr>
                            <th scope="row">動物類群：</th>
                            <td><asp:Literal ID="animal2" runat="server"></asp:Literal></td>
                        </tr>
                        <tr>
                            <th scope="row">詳細類群：</th>
                            <td><asp:Literal ID="detail_animal" runat="server"></asp:Literal></td>
                        </tr>
                        <tr>
                            <th scope="row">調查者：</th>
                            <td><asp:Literal ID="collecter_ch" runat="server"></asp:Literal></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th scope="row">可能種類推測：</th>
                            <td><asp:Literal ID="deduce_species" runat="server"></asp:Literal></td>
                        </tr>
                        <tr>
                            <th scope="row">轉送：</th>
                            <td><asp:Literal ID="transfer" runat="server"></asp:Literal></td>
                        </tr>
                        <tr>
                            <th scope="row">備註：</th>
                        ...
                        <tr>
                            <th scope="row">校對：</th>
                            <td><asp:Literal ID="varify" runat="server"></asp:Literal></td>
                        </tr>
		    </tbody>
                </table>
            </div>
            <div class="col-12 col-lg-7">
		<table class="mb-4 itemTable" style="width:100%; height:100%">
