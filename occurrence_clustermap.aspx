<%@ page language="C#" autoeventwireup="true" CodeFile="occurrence_clustermap.aspx.cs" Inherits="occurrence_clustermap" %>
...
<html>
  <head>
	...
	for (var i = 0; i < xy_array.length - 1; i++) {
		...
		var title = "經度 : " + xy[0] + "\n" + "緯度 : " + xy[1];
		markers.addLayer(createMarker(xy[1],xy[0],title));
	}

	map.addLayer(markers);
    }

    function createMarker(y,x,title) {
	let m_icon = createIcon();
	return L.marker([y, x], { title: title, icon: m_icon });
    }
