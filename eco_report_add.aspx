<%@ Page Language="C#" MasterPageFile="front.master" AutoEventWireup="true" CodeFile="eco_report_add.aspx.cs" Inherits="eco_report_add" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContentPlaceHolder" runat="Server">
    ...
    <main class="container" id="page">
        ...
        <p class="my-3"><a href="eco_report.aspx">取消新增</a></p>
        <div class="row">
	    ...
	    <asp:Button ID="Add_Eco_report" Cssclass="btn btn-primary" runat="server" OnClick="Add_Eco_report_Click" Text="新增資料" />
        </div>
