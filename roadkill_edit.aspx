<%@ Page Language="C#" MasterPageFile="front.master" AutoEventWireup="true" CodeFile="roadkill_edit.aspx.cs" Inherits="roadkill_edit" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContentPlaceHolder" runat="Server">
    ...
    <div class="bg-gradient-primary">
        <div class="container">
            <div class="d-flex justify-content-between">
                <h4 class="py-2 h4 text-white">道路致死資料編輯</h4>
                <nav class="breadcrumbNav  d-none d-md-block d-lg-block d-xl-block"
                    ...
                    <ol class="breadcrumb mt12">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">道路致死資料編輯</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <main class="container" id="page">
	    ...
	    <asp:Button ID="Edit_Roadkill" Cssclass="btn btn-primary" runat="server" OnClick="Edit_Roadkill_Click" Text="修改" />
        </div>
    </main>
</asp:Content>
