<%@ Page Language="C#" MasterPageFile="front.master" AutoEventWireup="true" CodeFile="occurrence_add.aspx.cs" Inherits="occurrence_add" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContentPlaceHolder" runat="Server">
    ...
    <div class="bg-gradient-primary">
        <div class="container">
            <div class="d-flex justify-content-between">
                <h4 class="py-2 h4 text-white">生態調查資料新增</h4>
                <nav class="breadcrumbNav  d-none d-md-block d-lg-block d-xl-block"
                    ...
                    <ol class="breadcrumb mt12">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">生態調查資料新增</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <main class="container" id="page">
	    ...
	    <asp:Button ID="Add_Occurrence" Cssclass="btn btn-primary" runat="server" OnClick="Add_Occurrence_Click" Text="新增" />
        </div>
    </main>
</asp:Content>
