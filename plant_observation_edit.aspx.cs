...
public partial class plant_observation_edit : System.Web.UI.Page
{
    ...
    protected void Edit_Plant_observation_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            Response.Write("<script>alert('修改植栽資料完成!!'); location.href='Plant_observation.aspx?pid="+value_pid+"';</script>");
