...
public partial class roadkill_batch_tmp : System.Web.UI.Page
{
    ...
    protected void Insert_RoadKill_Click(object sender, EventArgs e)
    {
        ...
        string sqlCommand = " Begin Delete Roadkill_Month_NoRecord Where uid = @uid and years = Year(getdate()) and months = Month(getdate()); Insert Into Roadkill (site_ch,highway_id,direction,milestone,mileage,x,y,TM2_X,TM2_Y,date,range,type,weather,animal,detail_animal,collecter_ch,species,deduce_species,file1,file2,file3,file4,file5,path1,transfer,note,uid,upload_file,upload_date,Sensitive_level,image_file,animal2) Select site_ch,highway_id,direction,milestone,mileage,x,y,TM2_X,TM2_Y,date,range,type,weather,animal,detail_animal,collecter_ch,species,deduce_species,file1,file2,file3,file4,file5,path1,transfer,note,uid,upload_file,upload_date,Sensitive_level,image_file,'' as animal2 From RoadKill_tmp Where uid = @uid; delete From RoadKill_tmp Where uid = @uid; delete From RoadKill_error Where uid = @uid; end;";
