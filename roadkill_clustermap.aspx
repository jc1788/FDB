<%@ page language="C#" autoeventwireup="true" CodeFile="roadkill_clustermap.aspx.cs" Inherits="roadkill_clustermap" %>
...
<html>
  <head>
	...
	for (var i = 0; i < xy_array.length - 1; i++) {
		...
		var url = "roadkill_detail.aspx?id=" + xy[0];
		var title = "經度 : " + xy[2] + "\n" + "緯度 : " + xy[1];
		markers.addLayer(createMarker(xy[1],xy[2],url,title));
	}
